  ...
  return (
    <div className="section">
      ...
      <p className="h-para">
        ...
        security and integrity. Let us examine how it works! 🚀
      </p>
      <br />
      <h2 className="small-heading">Step 1 : Preprocessing the Message</h2>
      <p className="para">
        <b className="bold">🔍 The Beginning of SHA-256:</b>
      ...
      <p className="para">
        <b className="bold">📚 ASCII to Binary Table:</b>
        ...
        every character we use. 📖💡
        <br />
        In this way, we make sure our plain text is transformed into a language
        that SHA-256 can understand and work with - binary code! 💬🔢
      </p>
      <p className="para">
      ...
      <p className="para">
        ...
        <br />
        <br />
        📝 Now, we arrange these binary values in such a way that there are only
      ...
      <br />
      <br />
      <h2 className="small-heading">Step 2: Padding the Message 📏🔗</h2>
      <p className="para">
      ...
      <br />
      <br />
      <h2 className="small-heading">Step 3: Adding the Message Length 📏🔢</h2>
      <p className="para">
      ...
      <h2 className="small-heading">
        🔄 Step 4: Hash Computation Rounds (Compression Function) 🚀
      </h2>
      <p className="para">
      ...
      <p className="para">
        ...
        binary message, all ready and waiting for us. 📜
      </p>
      <p className="para">
      ...
      <h4 className="small-heading2">
        Very first let us try to understand and compute values of 𝞂<sub>1</sub>{" "}
        and 𝞂<sub>0</sub>. Begin with 𝞂<sub>0</sub> as starting function of this
        formula.In 𝞂<sub>0</sub> there are 3 stages for a Message M to get final
        output.
      </h4>
      <br />
      <br />
      ...
      <p className="para">
        ...
        This finish 𝞂<sub>0</sub> function's calculations.
      </p>
      <h4 className="small-heading2">
        Proceeding to next step where we find values of "𝞂<sub>1</sub> "
      </h4>
      <p className="para">
        𝞂<sub>1</sub> has same steps as we saw in 𝞂<sub>0</sub>. but there is
      ...
      <Figure10 />
      <p className="para">
        Now that we have computer both 𝞂<sub>0</sub> and 𝞂<sub>1</sub> and
      ...
      <h4 className="small-heading">
        Step5: Setting Initial Hash Values in SHA-256 🗝️🔢
      </h4>
      ...
      <div className="ml-2">
        ...
        <ol className="ml-4">
          ...
          <li>They are the seeds from which the final hash will grow. 🌱</li>
        </ol>
      </div>
